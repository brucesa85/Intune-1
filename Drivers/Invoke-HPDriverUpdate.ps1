...
.NOTES
    ...
    1.0.3 - (2021-04-06) Added a new parameter HPIAAction that controls whether to Download or Install applicable drivers
#>
            ...
            "Execute" {
                try {
                    ...
                    try {
                        ...
                        Install-HPImageAssistant -DestinationPath $HPImageAssistantExtractPath -Extract -Quiet -Verbose -ErrorAction Stop
